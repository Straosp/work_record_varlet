...
// 组合式 API 风格
import {LoginAccount, REGISTER_LOGIN_ACCOUNT} from "../net/app-url.ts";
...
function login() {
  ...
  postRequest<Token>(REGISTER_LOGIN_ACCOUNT,{
    params: {
      "phone": phone.value,
...
<template>
  ...
  <var-form>
    ...
    <var-button class="login-btn" auto-loading loading-type="disappear" type="primary"  @click="login" size="large" block>注册并登录</var-button>
  </var-form>
</template>
